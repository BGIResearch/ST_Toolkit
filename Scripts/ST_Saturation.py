...
def getSaturationFig(saturationFile, outdir, binSize=200, readsScale=1):
    ...
    requiredSa = 0.8
    ax.plot(sadf['bar_x']/readsScale, sadf['bar_y1'], marker='o')
    ...
    ax.plot(sadf['bar_x']/readsScale, sadf['bar_y2'], marker='o')
    ax.set_xlabel("Total reads number of sampling")
    ...
    ax.plot(sadf['bin_x']/readsScale, sadf['bar_y1'], marker='o')
    ax.set_xlabel("Total reads number of sampling")
    ax.set_ylabel("Sequencing saturation")
    plt.axhline(requiredSa, color='green', lw=1, alpha=0.7)
    ax.grid()
    ax = plt.subplot(1, 3, 2)
    ax.plot(sadf['bin_x']/readsScale, sadf['bin_y2'], marker='o')
    ax.set_xlabel("Total reads number of sampling")
